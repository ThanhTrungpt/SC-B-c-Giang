...
function createfile_bm0902(params, rowRepair = null) {
    ...
    //params.mrDecisionDate
    console.log("[createfile_bm0902] - Ngày quyết định khảo sát:", params.mrDecisionDate);
    // Định dạng lại với params.mrDecisionDate là "2025-11-10"
    const [year_mrDecisionDate, month_mrDecisionDate, day_mrDecisionDate] = params.mrDecisionDate.split('-');
